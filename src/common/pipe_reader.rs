...
/// Read lines from a pipe as soon as they come out.
///
/// By ArtemGr at https://gist.github.com/ArtemGr/db40ae04b431a95f2b78
...
impl PipeStreamReader {
    ...
    fn new<R: io::Read + Send + 'static>(mut stream: Box<R>) -> PipeStreamReader {
        PipeStreamReader {
            lines: {
                let (tx, rx) = channel();
